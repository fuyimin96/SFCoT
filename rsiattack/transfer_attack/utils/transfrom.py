...
op = [vertical_shift, horizontal_shift, vertical_flip,
      horizontal_flip, rotate180, scale, resize, 
      add_noise, drop_out, Jitter]

op_bk = [vertical_shift, horizontal_shift, vertical_flip,
      horizontal_flip, rotate180, scale, resize, 
      add_noise, drop_out, Solarize, Invert]